...
#define PHY_BASEADDR_CPUSYS_MOUDLE		0x22040000 /* SECURE */
...
/* SYS Base Address SECURE*/
#define PHY_BASEADDR_SYS_MODULE_S			0x20040000
#define PHY_BASEADDR_SYSREG_SYS_S			(PHY_BASEADDR_SYS_MODULE_S)
#define PHY_BASEADDR_SYSREG_CPU_S			(PHY_BASEADDR_SYS_MODULE_S + 0x2000000)
#define PHY_BASEADDR_SYSREG_DDR_S			(PHY_BASEADDR_SYS_MODULE_S + 0x3000000)
#define PHY_BASEADDR_SYSREG_USB_S			(PHY_BASEADDR_SYS_MODULE_S + 0x4000000)
#define PHY_BASEADDR_SYSREG_MM_S			(PHY_BASEADDR_SYS_MODULE_S + 0x5000000)
#define PHY_BASEADDR_SYSREG_HSIF_S		(PHY_BASEADDR_SYS_MODULE_S + 0x6000000)
